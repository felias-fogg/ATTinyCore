...
for x in boards:
  ...
  printProp(x,".menu.lto.Os_flto=LTO enabled")
  printProp(x,".menu.lto.Os_flto.compiler.c.extra_flags=-Wextra -flto -g")
  printProp(x,".menu.lto.Os_flto.compiler.c.elf.extra_flags=-w -flto -g")
  printProp(x,".menu.lto.Os_flto.compiler.cpp.extra_flags=-Wextra -flto -g")
  printProp(x,".menu.lto.Os_flto.ltoarcmd=avr-gcc-ar")
  printProp(x,".menu.lto.Os=LTO disabled")
  printProp(x,".menu.lto.Os.compiler.c.extra_flags=")
  printProp(x,".menu.lto.Os.compiler.c.elf.extra_flags=")
  printProp(x,".menu.lto.Os.compiler.cpp.extra_flags=")
  printProp(x,".menu.lto.Os.ltoarcmd=avr-ar")
